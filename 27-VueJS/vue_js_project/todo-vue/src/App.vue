...
import { reactive } from "vue";
  ...
  const getTarefasPendentes = () => {
    return estado.tarefas.filter(tarefa => !tarefa.finalizada) // Retorna um array de tarefas pendentes
  }

  const getTarefasFinalizadas = () => {
    return estado.tarefas.filter(tarefa => tarefa.finalizada) // Retorna um array de tarefas finalizadas
  }
